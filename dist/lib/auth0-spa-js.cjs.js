...
class Auth0Client {
    ...
    async _prepareAuthorizeUrl(authorizationParams, appState, authorizeOptions, fallbackRedirectUri) {
    ...
    async loginWithPopup(options, config) {
        ...
        const params = await this._prepareAuthorizeUrl(options.authorizationParams || {}, undefined, {
    ...
    async _getTokenFromIFrame(options) {
        ...
        const {url: url, state: stateIn, nonce: nonceIn, code_verifier: code_verifier, redirect_uri: redirect_uri, scope: scope, audience: audience} = await this._prepareAuthorizeUrl(params, undefined, {
            response_mode: "web_message"
        }, window.location.origin);
        try {
